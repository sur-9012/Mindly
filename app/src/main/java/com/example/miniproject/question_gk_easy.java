...
public class question_gk_easy extends AppCompatActivity {
    ...
    String questions[] = {
            ...
            "Rainbow consists of how many colors",
            "How many days are there in a leap year?",
            "Which is the biggest continent in the world?"

    };
    String answers[] = {"Camel","24","7","366","Asia"};
    String opt[] = {
            "Anteater","Camel","Elephant","Tiger",
            "24","32","36","12",
            "6","8","2","7",
            "365","364","366","365.5",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_gk_easy);
